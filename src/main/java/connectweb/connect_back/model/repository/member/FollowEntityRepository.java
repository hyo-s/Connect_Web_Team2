...
public interface FollowEntityRepository extends JpaRepository<FollowEntity, Integer> {
    ...
    List<Map<Object,Object>> doFollowingNameGet(String mno);
}
